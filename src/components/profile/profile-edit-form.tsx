...
const ProfileEditForm: React.FC<ProfileEditFormProps> = ({
  ...
  const isValid = !displayNameError && !descriptionError && !websiteError;
  ...
  return (
    <div>
      <h1 className="font-mono text-h1 text-navy uppercase tracking-tight mb-6">
        Edit Profile
      </h1>
      ...
      <div className="app-card">
        <div className="flex flex-col gap-6">
          ...
          {saveError && (
            <p
              className="text-body-sm text-red-600 bg-red-50 border border-red-200 rounded px-4 py-3"
              role="alert"
            >
              {saveError}
            </p>
